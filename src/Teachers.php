...
if (isset($_POST['create'])) 
{
  ...
  $query = "INSERT INTO `Teachers` (TeacherName, TeacherTitle, TeacherEmail, SubjectID, SubjectDepartmentID, SubjectInstituteID) VALUES (NULLIF('$name', ''), NULLIF('$title', ''), NULLIF('$email', ''), '$subid', '$depid', '$instid')";
